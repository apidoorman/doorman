    ...
    <ProtectedRoute requiredPermission="view_analytics">
      <Layout>
        ...
        <DetailModal
          ...
          title={`User Details: ${selectedUser || ''}`}
        >
          {selectedUser && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Requests</p>
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">
                    {overview?.top_users.find(u => u.user === selectedUser)?.count.toLocaleString() || 'N/A'}
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Detailed user analytics and activity breakdown will be available in the next update.
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  This modal demonstrates the drill-down capability. In production, this would show:
                </p>
                <ul className="list-disc list-inside text-sm text-gray-500 dark:text-gray-500 mt-2 space-y-1">
                  <li>APIs accessed by this user</li>
                  <li>Request patterns and frequency</li>
                  <li>Quota usage and limits</li>
