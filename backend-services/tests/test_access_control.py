...
async def test_group_and_subscription_enforcement(login_client, authed_client, monkeypatch):
    # Create api restricted to team1
    ...
    # Create another group and user bob not in team1
    ...
    # viewer1 is in team1 already, subscribe viewer1 succeeds
    ...
    # bob is not in allowed group; subscribe should fail 403
    ...
    # Monkeypatch gateway network and limits
