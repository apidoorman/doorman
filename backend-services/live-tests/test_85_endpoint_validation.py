...
def test_rest_endpoint_validation_blocks_invalid_payload(client):
    ...
    try:
        ...
        # Create API and POST endpoint /create
        ...
        # Fetch endpoint to get endpoint_id
        ...
        # Create validation: payload must have user.name string min 2 and age number >= 1
        schema = {
            'validation_schema': {
        ...
        # Invalid request (missing fields) should be blocked
        ...
        # Gateway uses GTW011 for validation failures
